...
ServerEvents.recipes(event => {
    ...
    const disksavior_fdr_batch_multiplier = 1024//流体钻机电解批处理乘数
    disksavior_fdr_data.forEach(r => {
        //let fdr_mv = r.outf.map(i => `${i.split(' ')[0]} ${Number(i.split(' ')[1]) *1.5* 1024}`)
        gtr.electrolyzer(`disksavior:fdr_t${r.tier}_mv`)
            .notConsumable('1024x gtceu:mv_fluid_drilling_rig')
            .notConsumable(r.notc)
            .outputFluids(r.outf.map(i => `${i.split(' ')[0]} ${Number(i.split(' ')[1]) * disksavior_fdr_batch_multiplier * 1.5}`))
            .EUt(GTValues.VA[GTValues.HV])
            .duration(2 * disksavior_fdr_batch_multiplier)
        gtr.electrolyzer(`disksavior:fdr_t${r.tier}_hv`)
            .notConsumable('1024x gtceu:hv_fluid_drilling_rig')
            .notConsumable(r.notc)
            .outputFluids(r.outf.map(i => `${i.split(' ')[0]} ${Number(i.split(' ')[1]) * disksavior_fdr_batch_multiplier * 1.5 * 16}`))
            .EUt(GTValues.VA[GTValues.EV])
            .duration(2 * disksavior_fdr_batch_multiplier)
        gtr.electrolyzer(`disksavior:fdr_t${r.tier}_ev`)
            .notConsumable('1024x gtceu:ev_fluid_drilling_rig')
            .notConsumable(r.notc)
            .outputFluids(r.outf.map(i => `${i.split(' ')[0]} ${Number(i.split(' ')[1]) * disksavior_fdr_batch_multiplier * 1.5 * 256}`))
    ...
    gtr.cosmos_simulation('disksavior:cosmos_simulation_super_pro_max_plus_glodversion')
        ...
        .itemOutputs(disksavior_csi_16384)
        .outputFluids(disksavior_csf_16384)
        .duration(19660800)
    ...
    gtr.large_chemical_reactor('disksavior:cosmos_simulation_1')
        ...
        .itemOutputs(disksavior_csi)
        .outputFluids(disksavior_csf)
    ...
    //屠宰场电解
    const ds_slaughterhouse = ['16x minecraft:chicken', '16x minecraft:porkchop', '16x minecraft:beef', '16x minecraft:rabbit', '16x minecraft:mutton', '16x minecraft:cod', '16x minecraft:salmon', '64x minecraft:wheat', '32x minecraft:carrot', '32x minecraft:potato', '16x minecraft:poppy', '32x minecraft:feather', '32x minecraft:string', '16x minecraft:leather', '32x minecraft:bone', '16x minecraft:rabbit_hide', '8x minecraft:ghast_tear', '8x minecraft:ender_pearl', '32x minecraft:gunpowder', '32x minecraft:rotten_flesh', '16x minecraft:spider_eye', '16x minecraft:slime_ball', '8x minecraft:blaze_rod', '8x minecraft:rabbit_foot', 'minecraft:wither_skeleton_skull', '64x minecraft:ink_sac', '64x minecraft:glow_ink_sac', '8x minecraft:nautilus_shell', '16x minecraft:iron_ingot', '16x minecraft:gold_ingot', '16x minecraft:copper_ingot', '32x minecraft:gold_nugget', '16x minecraft:emerald', '32x minecraft:coal', '32x minecraft:redstone', '16x minecraft:glowstone_dust', '32x minecraft:bamboo', '32x minecraft:stick', '32x minecraft:arrow', '32x minecraft:sugar', '64x minecraft:white_wool', '32x minecraft:egg', '16x minecraft:glass_bottle']
